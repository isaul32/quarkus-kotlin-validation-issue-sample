# quarkus-kotlin-validation-issue-sample Project
...
You can then execute your native executable with: `./build/quarkus-kotlin-validation-issue-sample-1.0.0-SNAPSHOT-runner`
